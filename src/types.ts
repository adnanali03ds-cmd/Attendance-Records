...
export interface AttendanceRecord {
  ...
  status: 'present' | 'late';
  location?: AttendancePunchLocation;
  checkInLocation?: AttendancePunchLocation;
  checkOutLocation?: AttendancePunchLocation;
}

export interface AttendancePunchLocation {
  campusId?: string;
  campusName?: string;
  latitude: number;
  longitude: number;
